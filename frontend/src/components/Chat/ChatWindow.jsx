...
const ChatWindow = ({ conversation, onClose, onBack }) => {
  ...
  return (
    <div className="fixed bottom-16 sm:bottom-20 right-2 sm:right-4 w-[95vw] sm:w-96 h-[70vh] sm:h-125 max-h-150 bg-white rounded-xl sm:rounded-2xl shadow-2xl flex flex-col border border-gray-200 z-50 animate-in slide-in-from-bottom-5">
      {/* Header */}
      <div className="p-3 sm:p-4 bg-linear-to-r from-emerald-500 to-emerald-600 text-white rounded-t-xl sm:rounded-t-2xl flex justify-between items-center">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-1.5">
              ...
              {partner?.isSuperAdmin && (
                <span className="inline-flex items-center gap-0.5 text-[9px] sm:text-[10px] px-1.5 sm:px-2 py-0.5 bg-linear-to-r from-purple-500 to-purple-600 text-white rounded-full font-bold shadow-sm border border-purple-400/30">
                  <svg
        ...
        <button
          onClick={onClose}
          className="p-1 hover:bg-emerald-600 rounded-lg transition-colors shrink-0"
      ...
      {/* Messages Area */}
      <div className="flex-1 overflow-y-auto p-3 sm:p-4 bg-linear-to-b from-gray-50 to-white space-y-3 sm:space-y-4">
        {isLoading ? (
          ...
          <>
            {messages.map((msg, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`max-w-[80%] sm:max-w-[75%] px-3 sm:px-4 py-2 rounded-2xl text-sm wrap-break-word ${
                      isMe
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] block mt-1 ${isMe ? "text-emerald-100" : "text-gray-400"}`}
                    >
      ...
      <form
        ...
        className="p-3 sm:p-4 bg-white border-t border-gray-100 rounded-b-xl sm:rounded-b-2xl"
      >
        <div className="flex gap-2">
          ...
          <button
            ...
            className="p-2 sm:p-2.5 bg-emerald-500 text-white rounded-full hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105 active:scale-95 shadow-md disabled:transform-none shrink-0"
