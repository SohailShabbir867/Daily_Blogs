...
const ConversationList = ({ onSelectConversation, onClose, onNewChat }) => {
  const { user } = useAuth();
        ...
        {loading ? (
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-400 text-xs mt-2">
              Click the + button or "Start a New Chat" to begin.
            </p>
          </div>
        ) : (
                ...
                >
                  <div className="relative shrink-0">
                    <img
                      src={
                        partner.avatar ||
                        `https://ui-avatars.com/api/?name=${encodeURIComponent(partner.name)}&background=${partner.isSuperAdmin ? "9333ea" : partner.role === "admin" ? "10b981" : "3b82f6"}&color=fff`
                      }
                      alt={partner.name}
