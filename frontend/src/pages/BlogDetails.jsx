          ...
          <div className="p-4 sm:p-8 md:p-12 lg:p-16">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                /* USE_PROFILES.html uses DOMPurify's full safe attribute map so img[src] URI checks work.
                   A hand-picked ALLOWED_ATTR list was replacing defaults and could drop valid image URLs. */
