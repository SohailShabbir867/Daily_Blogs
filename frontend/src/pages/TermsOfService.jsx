  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-white to-green-50/30">
      <SEO
        ...
        description="Read Daily Blogs' terms of service to understand the rules, guidelines, and policies for using our platform. Fair usage policy and user responsibilities."
        keywords="terms of service, user agreement, terms and conditions, usage policy, daily blogs terms, platform rules"
        type="website"
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-white/80 mt-2">
                Legal Agreement for Daily Blogs Users
              </p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-10 space-y-10">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-amber-700 text-sm mt-1">
                      ...
                      Daily Blogs. By creating an account or using our services,
              ...
              <section id="agreement">
                ...
                <div className="text-gray-600 leading-relaxed space-y-4">
                  <p>
                    By accessing or using Daily Blogs ("the Service"), you agree
                    to be bound by these Terms of Service ("Terms"). These Terms
                    constitute a legally binding agreement between you ("User,"
                    "you," or "your") and Daily Blogs ("we," "us," or "our").
                  </p>
                  <p>
                    If you do not agree to all the terms and conditions of this
                    agreement, you must not access or use the Service. Your
                    continued use of the Service following the posting of any
                    changes constitutes acceptance of those changes.
                  </p>
                  <p>
                    We reserve the right to modify, update, or replace these
                    Terms at any time. It is your responsibility to review these
                ...
                <div className="text-gray-600 leading-relaxed space-y-4">
                  ...
                  <ul className="list-none space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Be at least <strong>13 years of age</strong> (or the
                ...
                <div className="text-gray-600 leading-relaxed space-y-4">
                  <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                    ...
                    <p>
                      ...
                      providing your name, email address, and a secure password.
                      You must ensure all information is accurate and
                      up-to-date.
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                  ...
                  <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                    ...
                    <p>
                      We reserve the right to suspend, disable, or terminate
                      accounts that violate these Terms, engage in fraudulent
                      activity, or pose a security risk to other users or our
                      platform.
                    </p>
                  </div>
                </div>
              ...
              <section id="content">
                ...
                <div className="text-gray-600 leading-relaxed space-y-4">
                  <p>
                    ...
                    content you create and post (comments, messages, blog
                    posts). By posting content, you grant Daily Blogs a
                    worldwide, non-exclusive, royalty-free license to use,
                    display, reproduce, and distribute your content on our
                    platform.
                  </p>
                  <p>
                    <strong>Content Standards:</strong> You agree NOT to post
                    content that is:
                  </p>
                  ...
                  <p className="text-sm bg-blue-50 text-blue-700 p-4 rounded-lg mt-4">
                    💡 <strong>Note:</strong> We reserve the right to remove any
                    content that violates these standards without prior notice.
                  </p>
                </div>
              </section>
              ...
              <section id="intellectual">
                ...
                <div className="text-gray-600 leading-relaxed space-y-4">
                  <p>
                    The Daily Blogs platform, including its design, logo,
                    trademarks, and original content, is protected by copyright,
                    trademark, and other intellectual property laws.
                  </p>
                  <p>You may NOT:</p>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      Copy, modify, or distribute any part of our platform
                      without permission
                    </li>
                    <li>
              ...
              <section id="communications">
                ...
                <div className="text-gray-600 leading-relaxed space-y-4">
                  ...
                  <p>
                    You may unsubscribe from non-essential communications at any
                    time through your account settings or by clicking the
              ...
              <section id="third-party">
                ...
                <div className="text-gray-600 leading-relaxed">
                  <p>
                    ...
                    policies, or practices of third-party sites. Your use of
              ...
              <section id="disclaimer">
                ...
                <div className="bg-gray-100 rounded-xl p-6 text-gray-700 text-sm uppercase tracking-wide leading-relaxed">
                  ...
                  ERROR-FREE. WE DISCLAIM ALL WARRANTIES, INCLUDING WARRANTIES
              ...
              <section id="liability">
                ...
                <div className="bg-gray-100 rounded-xl p-6 text-gray-700 text-sm uppercase tracking-wide leading-relaxed">
                  TO THE MAXIMUM EXTENT PERMITTED BY LAW, DAILY BLOGS AND ITS
                  AFFILIATES SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
                  SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT
                  LIMITED TO LOSS OF PROFITS, DATA, OR GOODWILL, ARISING FROM
              ...
              <section id="indemnification">
                ...
                <div className="text-gray-600 leading-relaxed">
                  <p>
                    ...
                    Blogs, its officers, directors, employees, agents, and
                    affiliates from any claims, damages, losses, liabilities,
              ...
              <section id="termination">
                ...
                <div className="text-gray-600 leading-relaxed space-y-4">
                  ...
                  <p>
                    ...
                    immediately. You may also request to delete your account at
              ...
              <section id="governing">
                ...
                <div className="text-gray-600 leading-relaxed">
                  <p>
                    ...
                    or your use of the Service shall be resolved through
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <a
                            href="mailto:legal@dailyblogs.com"
              ...
              <div className="pt-8 mt-8 border-t border-gray-100">
                <p className="text-center text-gray-500 text-sm">
                  By using Daily Blogs, you acknowledge that you have read,
